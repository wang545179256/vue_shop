		...
		<el-card>
			...
			<el-row class="cat_opt">
				<el-col>
					<span>选择商品分类：</span>
					<!-- 选择商品分类的级联选择框 -->
					<el-cascader ref="cascader" v-model="selectedCateKeys" :options="catelist" :props="cascaderProps" @change="handleChange"></el-cascader>
				</el-col>
			</el-row>
...
<script>
	export default {
		...
		methods: {
			...
			async getParamsData() {
				//证明选中的不是三级分类（新版本可用Prop的checkStrictly属性）
